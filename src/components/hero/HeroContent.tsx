...
const HeroContent = () => {
  ...
  return <div className="max-w-3xl">
      ...
      <h1 ref={titleRef} className="reveal-text text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 glow-text">
        Crafting impactful products that shape the future of technology.
      </h1>
      
      <p ref={subtitleRef} className="reveal-text text-lg md:text-xl text-foreground/80 max-w-2xl mb-8">
      ...
      <div ref={ctaRef} className="reveal-text flex flex-wrap gap-4">
        ...
        <a href="https://linkedin.com/in/hisham86" target="_blank" rel="noopener noreferrer" className="btn-secondary flex items-center gap-2">
        ...
        <Button onClick={handleOpenWorkSamples} variant="outline" className="border-primary/40 text-primary hover:bg-primary/10 flex items-center gap-2">
          <Download size={16} />
          Download My Work Samples
        </Button>
        <Button onClick={handleDownloadCV} variant="outline" className="border-orange-500/40 text-orange-400 hover:bg-orange-500/10 flex items-center gap-2">
          <FileText size={16} />
          My Updated CV
        </Button>
